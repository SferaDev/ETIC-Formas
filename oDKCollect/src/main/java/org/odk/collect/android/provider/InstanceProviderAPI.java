...
public final class InstanceProviderAPI {
    ...
    public static final class InstanceColumns implements BaseColumns {
        ...
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.odk.instance";        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/instances");
