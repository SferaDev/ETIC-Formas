...
public final class FormsProviderAPI {
    ...
    public static final class FormsColumns implements BaseColumns {
        ...
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.odk.form";        public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/forms");
